...
class OnHoverDropDownItem extends StatefulWidget {
  final Widget Function(bool isHovered) builder;
  const OnHoverDropDownItem({Key? key, required this.builder}) : super(key: key);
  @override
  _OnHoverDropDownItemState createState() => _OnHoverDropDownItemState();
}

class _OnHoverDropDownItemState extends State<OnHoverDropDownItem> {
  bool isHovered = false;
  @override
  Widget build(BuildContext context) {
    // on hover animation movement matrix translation
    final hovered = Matrix4.identity()..translate(10.0,0,0);
